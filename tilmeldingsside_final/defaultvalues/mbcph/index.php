      ...
      <div class="col-sm-8 offset-sm-2">
        ...
        <div class="row mainContent">
          <div class="col">
            ...
            <h3>Ta' en ledsager med.</h3>
            <p>Du kan tage din partner, ven eller kollega med til lanceringen af den ny Sprinter til Classic Race Aarhus. Husk, at tilmelde vedkommende i formularen neden for.</p>
            ...
            <p>Til de første 250 tilmeldte vil det være muligt at reserve en parkeringsplads, hvorfra vi tilbyder shuttle bus til hovedindgangen.</p>

            <h3>Transport til og fra Aarhus.</h3>
            <p class="pb-2">
              Vi sørger for, at du kan blive transporteret til og fra Aarhus via bus. Angiv i din tilmelding om du vil med bussen eller om du selv sørger for transport.
              <br>
              Der er følgende afgange til Aarhus:
            </p>
            <ul>
              <li>Søborg kl. 06.30</li>
              <li>Greve kl. 06.30</li>
            </ul>
            <p>
              Busserne kører retur igen kl. 18.15.
              <br>
              Specifikke opsamlings- og ankomststeder vil du modtage efter tilmeldingsfristen.
            </p>
